  ...
  return (
    <div>
      <nav className='bg-black text-white h-24 flex items-center justify-between'>
        ...
        <span className='text-[#fed478fe] text-bold '>{user.name + " " +user.surname}</span>
            <button onClick={() => {
      ...
      <div className='bg-black flex flex-row justify-between'>
        ...
        <div className=' bg-slate-50 border-2 border-[#f0b954] rounded space-x-2 w-full p-4 pb-0 h-screen mt-4 flex flex-col space-y-2'>
          <div className='bg-[#fbce8b] border-2 border-[#f0b954] h-4 rounded flex flex-auto  justify-between '>
