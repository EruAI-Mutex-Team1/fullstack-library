      ...
      <div className='bg-[#fdf2d8fe] h-screen flex flex-col gap-3 items-center '>
        ...
        <form className='bg-[#fde5b1fe] border-2 border-[#f9ca67fe] h-4/5 w-4/5 rounded'>
          ...
          <div className='flex justify-between h-3/5 gap-2 mt-2 ml-2 mr-2'>
            ...
            <form className='bg-slate-50 border-2 border-[#f9ca67fe] rounded h-auto flex flex-row w-1/5 flex-wrap'>
              {numOfPages.map((page, index) => (
                <div key={index} className='bg-[#f9ca67fe] rounded-full flex items-center h-6 w-6 m-1'>
          ...
          <form className='bg-[#fde5b1fe] h-20 w-3/4 ml-12 flex flex-row justify-end gap-3 '>
