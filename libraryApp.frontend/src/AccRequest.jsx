          ...
          <div className=' bg-slate-500 w-[1500px] h-[780px] overflow-y-auto max-h-[780px]'>
            ...
            <thead className='bg-[#141b295e] text-sm'>
              <tr className='border-b-2 border-black'>
                ...
                <th className='py-3  pr-[100px] font-serif'>GENDER</th>
                <th className='py-3  pr-[100px] font-serif'>DATE OF BIRTH</th>
                <th className='py-3  pr-[270px] font-serif'>ACTIONS</th>
              </tr>
            </thead>
            <tbody className='text-white text-[15px]'>
            <tr className='border-b-2 border-black'>
                <td className='py-3 pl-4 font-medium'>fasdv dvsaf fbvdfsbd</td>
                <td className='py-3 font-thin'>useruser</td>
                <td className='py-3 font-thin'>female</td>
